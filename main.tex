...
\begin{frame}
\begin{tikzpicture}
	\node[text width=2cm] (a) {\reflectbox{\includegraphics[width=\textwidth]{Pics/Tourist.png}}};
\end{tikzpicture}
\end{frame}
...
\begin{frame}
	...
	\begin{tabular}{p{.49\textwidth}p{.49\textwidth}}
		...
		Последовательно перебирает все окрестные вершины, пока не выберет  целевую вершинув качестве активной. & Последовательно релаксирует по всем ребрам для каждой длины пути, в итоге получает матрицу с кратчайшими весами от $s$ до всех остальных вершин.\\
		\begin{itemize}
